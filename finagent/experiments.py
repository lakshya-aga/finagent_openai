...
-- NOTE: idx_debates_source lives in _SCHEMA_POST_MIGRATE, not here, so
-- legacy DBs without the `source` column can ALTER it in first via
-- _migrate() before the index is created.
